...
[![Stars](https://img.shields.io/github/stars/Wave-Execute-Update-v3.8?style=flat-square)](https://github.com)
...
git clone https://github.com/Wave-Execute-Update-v3.8.git
cd Wave-Execute-Update-v3.8
...
Wave v3.8 runs fully offline, uses under 40 MB RAM at idle, and ships with more bundled scripts than most alternatives.
